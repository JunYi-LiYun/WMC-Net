...
class DeformConv2d(nn.Module):
    def __init__(self, inc=1, outc=1, kernel_size=3, padding=1, stride=1, bias=None, modulation=False):
        """
        Args:
        ...
        self.conv = nn.Conv2d(inc, outc, kernel_size=kernel_size, stride=1, bias=bias)
